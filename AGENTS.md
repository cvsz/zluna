...
- Preserve repository-specific architecture and existing instructions; prefer the smallest safe diff.
- Never commit secrets or disable tests/security/policy gates merely to make CI pass.
- Verify relevant checks before claiming completion and keep production-readiness claims evidence-based.
